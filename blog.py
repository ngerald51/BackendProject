...
class BlogFront(BlogHandler):
    def get(self):
        if self.request.get('game') and self.user:
...
post.id=id
post.put()
#self.render("editpost.html", content=content, id=id)
self.redirect('/blog/')
print "TEST"
"""
...
class NewPost(BlogHandler):
    ...
    def post(self):
        ...
        #Form Validation for signup page, checking both subject and content is entered
...
class Signup(BlogHandler):
    ...
    def post(self):
        ...
        if not valid_username(self.username):
            params['error_username'] = "That's not a valid username. Please ensure your username is at least 5 characters"
            have_error = True

        if not valid_password(self.password):
            params['error_password'] = "That wasn't a valid password. Please ensure your username is at least 5 characters"
            have_error = True
